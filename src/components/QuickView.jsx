      ...
      <div className="relative bg-white max-w-5xl w-full" onClick={(event) => event.stopPropagation()}>          
        ...
        <div className="max-w-4xl mx-auto p-6 flex flex-col md:flex-row gap-10">
          ...
          <div className="flex-1">
            ...
            {/* Select Colors */}
            <div className="mb-6">
              <h3 className="text-gray-700 font-semibold mb-2">Select Colors:</h3>
              <div className="flex gap-6">
                {product.colors.map((color) => (
                  <div className="flex flex-col items-center">
                    <div className={`w-8 h-8 ${color.equivalent} rounded-full`}></div>
                    <p className="text-sm text-gray-500 mt-1">{color.name}</p>
                  </div>
                ))}
              </div>
            </div>
            ...
            <div className="flex justify-between items-center mb-4">
              ...
              <p className="text-gray-500 text-sm cursor-pointer hover:underline">Size Guide</p>
            </div>
